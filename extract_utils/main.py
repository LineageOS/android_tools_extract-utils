...
class ExtractUtils:
    ...
    def backup_module_pinned_files(self, module: ExtractUtilsModule,
                                   backup_ctx: CopyCtx):
    ...
    def process_module_files(self, module: ExtractUtilsModule,
                             copy_ctx: CopyCtx, restore_ctx: CopyCtx):
        for proprietary_files in module.proprietary_files:
            file_list = proprietary_files.file_list
            assert file_list is not None
    ...
    def process_module_proprietary_files(self, module: ExtractUtilsModule):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            backup_ctx = CopyCtx(module.vendor_files_path, tmp_dir)
            restore_ctx = CopyCtx(tmp_dir, module.vendor_files_path)

            self.backup_module_pinned_files(module, backup_ctx)
            self.process_module_files(module, copy_ctx, restore_ctx)
