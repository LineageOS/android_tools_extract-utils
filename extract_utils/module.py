...
class ExtractUtilsModule:
    def __init__(
        ...
        self.extract_fns: List[extract_fn_type] = []
    ...
    def add_extract_partitions(self, partitions: List[str]):
        self.extract_partitions.extend(partitions)

    def add_extract_fn(self, extract_fn: extract_fn_type):
        self.extract_fns.append(extract_fn)
