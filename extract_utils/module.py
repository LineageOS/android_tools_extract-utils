...
class ProprietaryFile:
    ...
    def add_copy_files_guard(self, name: str, value: str, invert=False) -> Self:
        ...
        def guard_end_fn(makefiles: MakefilesCtx):
            write_mk_guard_end(makefiles.product_mk_out)
...
class FirmwareProprietaryFile(ProprietaryFile):
    def write_makefiles(
        ...
        write_mk_guard_begin('TARGET_DEVICE', module.device, makefiles.mk_out)
        ...
        write_mk_guard_end(makefiles.mk_out)
...
class ExtractUtilsModule:
    def __init__(
        ...
        extracted_firmware_files: Optional[List[str]] = None,
        ...
        if extracted_firmware_files is None:
            extracted_firmware_files = []
        self.extracted_firmware_files = extracted_firmware_files
    ...
    def get_extracted_firmware_files(self):
        return self.extracted_firmware_files
    ...
    def process_proprietary_files(
        ...
        for proprietary_file in self.proprietary_files:
            ...
            print(f'Processing {file_list_rel_path}')
