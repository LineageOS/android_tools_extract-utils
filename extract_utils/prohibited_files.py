...
This module blocks extraction of prohibited files including:
  ...
  â- Megvii / Face++ (face recognition, beautification, etc.)
  â- SenseTime license files (e.g. license.lic)
...
def fail_prohibited(paths: List[str]):
  ...
  â - Megvii / Face++ related libraries and assets:
    (e.g. lib*{M,m}eg*.so, lib*{M,m}g*.so, *{M,m}egvii*)

  â - SenseTime license artifacts:
    (e.g. license.lic)
