...
This module blocks extraction of known restricted third-party SDK artifacts,
including:

  • Megvii / Face++ (face recognition, beautification, etc.)
  • SenseTime license files (e.g. license.lic)

These are disallowed due to licensing and redistribution restrictions.

To extend this policy:
  - Add tokens to PROHIBITED_SO_TOKENS for shared libraries
  - Add entries to PROHIBITED_FILENAMES for exact matches
  - Add entries to PROHIBITED_SUBSTRINGS for generic matches
"""
...
from extract_utils.utils import color_print, Color
