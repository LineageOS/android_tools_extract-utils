...
class ProductPackagesCtx:
    def __init__(
        ...
        self.apps_enforce_uses_libs = apps_enforce_uses_libs
...
def write_app_package(
    ...
    enforce_uses_libs = ctx.apps_enforce_uses_libs
    uses_libs = optional_uses_libs = None
    if enforce_uses_libs:
    ...
    (
        ...
        .set('enforce_uses_libs', enforce_uses_libs or None, optional=True)
