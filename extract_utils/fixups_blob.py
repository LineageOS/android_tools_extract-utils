...
class blob_fixup:
    ...
    def binary_regex_replace_impl(
        ...
        **kargs,
        ...
        with open(file_path, 'wb', newline='') as f:
            f.write(data)

    def binary_regex_replace(self, search: bytes, replace: bytes):
    ...
    def sig_replace(self, pattern_str: str, replacement_str: str):
        pattern = bytes()
    ...
    def add_line_if_missing(self, text: str):
